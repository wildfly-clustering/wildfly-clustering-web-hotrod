 ...
 * @author Paul Ferraro
 */
public class HotRodSession<L> extends HotRodImmutableSession implements Session<L> {
    ...
    public HotRodSession(String id, InvalidatableSessionMetaData metaData, SessionAttributes attributes, AtomicReference<L> localContext, LocalContextFactory<L> localContextFactory, Remover<String> remover) {
